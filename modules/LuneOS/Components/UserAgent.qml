...
Item {
    ...
    readonly property string _template: "Mozilla/5.0 (LuneOS, like webOS/3.0.5; %1) AppleWebKit/%2 (KHTML, like Gecko) QtWebEngine/5.13.0 Chrome/73.0.3683.105 Safari/%2"
